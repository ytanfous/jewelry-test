...
function Card({name, phone, image,storeName, id}) {
    ...
    const formattedPhone = phone ? phone.replace(/(\d{2})(\d{3})(\d{3})/, "$1 $2 $3") : "-";
    ...
    return (
        <div
            ...
            <div className="relative h-32">
                <Link href={`/jewelry/jeweler/${id}`} passHref>
                    <Image
                        src={imageSrc}
                        alt=""
                        fill
            ...
            {productCount > 0 && (
                <div
                    className="relative grid items-center whitespace-nowrap select-none text-wrap bg-orange-500 text-white
        py-1 px-3 mx-auto text-[12px] -mt-4 w-auto max-w-full rounded-full shadow">
        <span>
            Quantité Produit : <span className="font-bold">{productCount}</span>
        </span>
                </div>
            )}
            {productCount === 0 && (
                <div
                    className="relative grid items-center whitespace-nowrap text-wrap select-none bg-green-500 text-white
        py-1 px-3 mx-auto text-[14px] -mt-4 w-auto max-w-full rounded-full shadow">
...
*/}
            ...
            <div className="flex  gap-1 m-1 flex-wrap">
{/*                <Link href={`/jewelry/jeweler/${id}?state=history`}
