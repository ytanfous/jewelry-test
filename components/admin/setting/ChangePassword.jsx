...
function ChangePassword() {
    ...
    const [formErrors, setFormErrors] = useState({ password: null });
    ...
    return (
        <>
            <div className="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
                <div className="relative flex flex-col mt-4 p-3 gap-4 min-w-0 break-words shadow-md rounded-2xl bg-clip-border transition-transform duration-300 ease-in-out bg-white">
                    <h3 className="text-lg font-semibold">Mettre à jour le mot de passe</h3>
                    <input
                    ...
                    />
                    {formErrors.password && <p className="text-red-700">{formErrors.password}</p>}
            ...
            <Modal open={modalIsOpen} onClose={() => setModalIsOpen(false)}>
                <div className="relative bg-white rounded-lg shadow">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500">Vous souhaitez vraiment Mettre à jour le mot de passe?</h3>
                        <input
                            type="password"
