...
function ImageOrderModal({ open, onClose, url }) {
    ...
    useEffect(() => {
        setLoading(true); // Reset loading state whenever URL changes
    }, [url]);
        ...
        <>
            <Modal open={open} onClose={onClose}>
                <div className="p-4">
                    ...
                    <div className="relative w-full w-full h-[300px] sm:h-[400px] md:h-[500px]">
                        {loading && (
                            <div
                                className="absolute inset-0 flex justify-center items-center bg-gray-200 bg-opacity-50">
                                <div role="status">
...
export default ImageOrderModal;
